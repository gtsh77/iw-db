...
CREATE TABLE IF NOT EXISTS `iwstats`.`profiles` (
  ...
  `points` MEDIUMINT(8) NULL DEFAULT 0,
  `wins` MEDIUMINT(8) NULL DEFAULT 0,
  `assists` MEDIUMINT(8) NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `iwstats`.`roundprofiles` (
  ...
  `roundId` MEDIUMINT(8) UNSIGNED NOT NULL,
  `playerId` MEDIUMINT(8) UNSIGNED NOT NULL,
  `wins` SMALLINT(3) NULL DEFAULT 0,
  `assists` SMALLINT(3) NULL DEFAULT 0,
  `losses` SMALLINT(3) NULL DEFAULT 0,
  `points` SMALLINT(3) NULL DEFAULT 0,
  `ratio` FLOAT(7,4) NULL DEFAULT 0,
  ...
  INDEX `ixWins` (`wins` ASC),
  INDEX `ixAssists` (`assists` ASC),
  INDEX `ixLosses` (`losses` ASC),
  INDEX `ixPoints` (`points` ASC),
